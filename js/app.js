...
import '../config.js';
import './data/bible_data.js?v=20260916_joined_plan_card_click_to_open';
import './data/bible_verse_counts.js';
import './copy/zh-Hant.js?v=20260916_joined_plan_card_click_to_open';
import './data/church_campaign.js?v=20260916_joined_plan_card_click_to_open';
import './design/design-tokens.js';
import './design/design-system-helpers.js?v=20260916_joined_plan_card_click_to_open';
import './design/icon-registry.js?v=20260916_joined_plan_card_click_to_open';
import './design/icons.js';
import './state.js?v=20260916_joined_plan_card_click_to_open';
import './auth.js?v=20260916_joined_plan_card_click_to_open';
import './auth-launch.mjs';
import './db.js?v=20260916_joined_plan_card_click_to_open';
import './utils.js?v=20260916_joined_plan_card_click_to_open';
import './gamification.js?v=20260916_joined_plan_card_click_to_open';
...
} from './login-onboarding-gate.mjs?v=20260916_joined_plan_card_click_to_open';
import { cleanupProductionStorage } from './production-cleanup.mjs';
import { initializePwa } from './pwa/PwaCoordinator.js?v=20260916_joined_plan_card_click_to_open';
...
import { SupabaseRepository } from './pwa/SupabaseRepository.js?v=20260916_joined_plan_card_click_to_open';
...
const moduleCache = {};
const RELEASE_ONBOARDING_MODULE_PATH = './modules/onboarding-helper.js?v=20260916_joined_plan_card_click_to_open';

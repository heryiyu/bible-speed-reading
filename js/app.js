...
appRouter.switchTab = async function (tabId, options = {}) {
  ...
  try {
    ...
    if (tabId === "dashboard-view") {
      ...
      const mod = await loadModule('plan', './modules/plan.js?v=20260711_localhost_login_fixed');
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  loadModule('plan', './modules/plan.js?v=20260711_localhost_login_fixed').then(mod => {
    if (mod && typeof mod.renderPlanView === 'function') {

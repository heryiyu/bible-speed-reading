...
import '../config.js';
import './data/bible_data.js?v=20260916_plan_ended_card_activeplan_resync';
import './data/bible_verse_counts.js';
import './copy/zh-Hant.js?v=20260916_plan_ended_card_activeplan_resync';
import './data/church_campaign.js?v=20260916_plan_ended_card_activeplan_resync';
import './design/design-tokens.js';
import './design/design-system-helpers.js?v=20260916_plan_ended_card_activeplan_resync';
import './design/icon-registry.js?v=20260916_plan_ended_card_activeplan_resync';
import './design/icons.js';
import './state.js?v=20260916_plan_ended_card_activeplan_resync';
import './auth.js?v=20260916_plan_ended_card_activeplan_resync';
import './auth-launch.mjs';
import './db.js?v=20260916_plan_ended_card_activeplan_resync';
import './utils.js?v=20260916_plan_ended_card_activeplan_resync';
import './gamification.js?v=20260916_plan_ended_card_activeplan_resync';
...
} from './login-onboarding-gate.mjs?v=20260916_plan_ended_card_activeplan_resync';
import { cleanupProductionStorage } from './production-cleanup.mjs';
import { initializePwa } from './pwa/PwaCoordinator.js?v=20260916_plan_ended_card_activeplan_resync';
...
import { SupabaseRepository } from './pwa/SupabaseRepository.js?v=20260916_plan_ended_card_activeplan_resync';
...
const moduleCache = {};
const RELEASE_ONBOARDING_MODULE_PATH = './modules/onboarding-helper.js?v=20260916_plan_ended_card_activeplan_resync';
